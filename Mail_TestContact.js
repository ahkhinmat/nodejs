...
let transporter = nodemailer.createTransport({
             ...
             secure: true,
             auth: {
                 user: 'hmdn.pbx@hoanmy.com',
                 pass: 'Tongdai@123456789@'
             }
        });
/*cấu hình mail*/
...
// var sendEmail = schedule.scheduleJob('0 39 8 ? * *', function(){
//     ScanLogAndSendMail ();
// });
ScanLogAndSendMail ();
/*Lịch gởi mail*/
    ...
    if(err === null) {  // keets noois thành công
     ...
     //   request.input('ID_PhongBan', sql.Int,140);
      //  request.input('ngay', sql.VarChar(10),'20200928');
        request.execute('[QLCC_GetLogToEmail]', function(err, recordsets, returnValue) {
            ...
            if(mang.length>0){
                for(var i=0;i<mang.length;i++){
                    ...
                    if(mangtam["Email"]){
                        ...
                        dem++;
                        let mailOptions = {
                          from: 'contactus.danang@hoanmy.com',
                          to: mangtam["Email"],
                          cc:"anh.phan@hoanmy.com",
