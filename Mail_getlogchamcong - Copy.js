...
//var sendEmail = schedule.scheduleJob('*/10 * * * * *', function(){
				...
				for(var i=0;i<mang.length;i++){
					...
					if(mangtam["Email"]){
						...
						let mailOptions = {
						  ...
						  to: mangtam["Email"],
						  cc:mangtam["EmailCC"],
						  subject:'Thông báo từ Hệ Thống Quản Lý Lịch và Log Chấm Công HMĐN',
						  attachments: [{
						        filename: 'footer-image-mail.png',
						        path: './footer-image-mail.png',
						        cid: 'unique@kreata.ee' //same cid value as in the html img src
						    }],
          				html: "<table border='1'><tr><th>Họ Tên</th><th>Ngày</th><th>Lịch</th><th>Log chấm</th></tr>"
          				...
          				+"</tr>"
          				+"</table>"
    					+"P/S: <i style='color:blue'>Đây là email tự động từ Hệ thống QL Lịch Chấm Công HMDN,"
