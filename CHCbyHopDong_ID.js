...
function GetDataReportHis_DMBN (hopdong_id_p) {
    ...
    connection_mysql.query('DELETE FROM ksk_ketqua WHERE HopDong_Id = '+hopdong_id_p , function (error, results, fields) {
        if (error) throw error;
        console.log('deleted ksk_ketqua error'+ error);
      });
      connection_mysql.query('DELETE FROM ksk_ketqua_tuvan WHERE HopDong_Id = '+hopdong_id_p , function (error, results, fields) {
        if (error) throw error;
        console.log('deleted ksk_ketqua_tuvan error'+ error);
      });
      connection_mysql.query('DELETE FROM ksk_ketqua_xetnghiem WHERE HopDong_Id = '+hopdong_id_p , function (error, results, fields) {
        if (error) throw error;
        console.log('deleted ksk_ketqua_xetnghiem error'+ error);
      });
      connection_mysql.query('DELETE FROM ksk_toathuoc WHERE HopDong_Id = '+hopdong_id_p , function (error, results, fields) {
        if (error) throw error;
        console.log('deleted ksk_toathuoc error'+ error);
      });
